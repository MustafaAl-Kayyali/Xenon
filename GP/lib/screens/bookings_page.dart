            ...
            Expanded(
              child: isUpcoming
                  ? (bookingProvider.bookings.isEmpty
                      ? EmptyState(icon: Icons.history, message: isArabic ? 'لا توجد حجوزات بعد' : 'No bookings yet', isDark: isDark)
                      : ListView.builder(
                  ...
                  : EmptyState(icon: Icons.history, message: isArabic ? 'لا توجد حجوزات سابقة' : 'No past bookings', isDark: isDark),
            ),
          ],
        ),
      ),
