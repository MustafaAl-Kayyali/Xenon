...
export const adminAnalyticsPreview = {
  data: {
    ...
    platform_performance: {
      ...
      vendors_leaderboard: [
        { vendor_company: 'Jordan Horizon Tours', totalRevenue: 68420 },
        { vendor_company: 'Desert Compass', totalRevenue: 54780 },
        { vendor_company: 'Nabataean Trails', totalRevenue: 49360 },
        { vendor_company: 'Aqaba Blue', totalRevenue: 42190 },
        { vendor_company: 'Dana Wild Jordan', totalRevenue: 38740 },
      ],
    },
